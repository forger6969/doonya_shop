  ...
  return (
    <section ref={ref} className="relative py-20 px-6 md:px-20 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div
          className="relative rounded-3xl overflow-hidden border border-green-500/10 bg-[#0d0d1a]"
          style={{ minHeight: 420 }}
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-10 p-8 md:p-14">
            ...
            >
              ...
              {!imgError ? (
                ...
                <div className="relative z-10 w-full aspect-[3/4] rounded-2xl bg-[#111827] border border-green-500/10 flex flex-col items-center justify-center gap-4 text-center p-6">
                  <div className="text-6xl float">⚡</div>
                  <div className="font-bebas text-2xl tracking-wider text-green-400">СКОРО</div>
                  <div className="text-slate-500 text-xs">Аниме-арт скоро будет здесь</div>
                  <div className="mt-2 text-xs text-slate-600 font-mono">
                    hero-anime.png →<br />landing/public/
                  </div>
                </div>
              )}
